...
"border-radius: 10px ;")
        ...
        self.listWidget.setGeometry(QtCore.QRect(470, 40, 271, 201))
        self.listWidget.setStyleSheet("border :2px solid white;\n"
"border-radius: 10px ;")
        self.listWidget.setObjectName("listWidget")
        self.listWIdget = QtWidgets.QListWidget(self.centralwidget)
        self.listWIdget.setGeometry(QtCore.QRect(470, 340, 271, 131))
        self.listWIdget.setStyleSheet("border :2px solid white;\n"
"border-radius: 10px ;")
        self.listWIdget.setObjectName("listWIdget")
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(MainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 771, 18))
